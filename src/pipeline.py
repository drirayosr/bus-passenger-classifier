...
def build_pipeline(bus_df, bus_stops_df, config=None):
    ...
    print(f"  6. PcaDBSCANTransformer (PCA={feature_eng['pca_n_components']}, " 
    ...
    if 'hdbscan_min_samples' in feature_eng and feature_eng['hdbscan_min_samples'] is not None:
        hdbscan_params['min_samples'] = feature_eng['hdbscan_min_samples']
    
    if 'hdbscan_cluster_selection_epsilon' in feature_eng:
        hdbscan_params['cluster_selection_epsilon'] = feature_eng['hdbscan_cluster_selection_epsilon']
    
    if 'hdbscan_cluster_selection_method' in feature_eng:
        hdbscan_params['cluster_selection_method'] = feature_eng['hdbscan_cluster_selection_method']
    ...
    pipeline = Pipeline([
        ...
        ('pca_dbscan', PcaDBSCANTransformer(
            dbscan=hdbscan_model,
            n_components=feature_eng['pca_n_components']
        ))
    ])
