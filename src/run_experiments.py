...
def run_experiment_grid():
    ...
    for i, exp_config in enumerate(experiments, 1):
        ...
        config['feature_engineering']['hdbscan_min_cluster_size'] = exp_config['hdbscan_min_cluster_size']
        config['feature_engineering']['hdbscan_cluster_selection_epsilon'] = exp_config['hdbscan_cluster_selection_epsilon']
    ...
    for result in results_summary:
        print(f"{result['name']:<45} {result['f1_score']:<12.4f} {result['accuracy']:<12.4f}")
